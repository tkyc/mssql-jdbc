...
/*
 * Maps SQL type to its minimum, maximum and null value temporal min/max values used are not DATEFORMAT dependent as in
...
enum SqlTypeValue {
    ...
    BIT(0, 1, null),
    DECIMAL(new BigDecimal("-1.0E38").add(new BigDecimal("1")), new BigDecimal("1.0E38")
